...
import { NarrowUpdateData, NarrowUpdateManyData, NarrowWhere } from './inputNarrowing.js';
export interface UpdateInput<Data, Select, Where, Include> extends FindUniqueInput<Select, Where, Include> {
